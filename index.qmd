...
## NMFS Openscapes FY22-23 {.minimal}

**July-September 2023**: Kick-off, engagement, planning, and coordinating for FY24. Bi-weekly meetings with the [FY23 NMFS mentors](https://nmfs-openscapes.github.io/mentors.html#mentors) to plan the year and identify strategic priorities and engagement. We also collaborated with Openscapes mentors across organizations – including NASA Earthdata, NOAA Fisheries, EPA, California Water Boards, Pathways to Open Science, Fred Hutch Cancer Center – to publish an article in *Ecology & Evolution*: [Shifting institutional culture to develop climate solutions with Open Science](https://onlinelibrary.wiley.com/doi/10.1002/ece3.11341). 
